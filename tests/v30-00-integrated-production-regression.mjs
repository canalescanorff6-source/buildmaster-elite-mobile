...
assert.equal(JSON.parse(read('public/manifest.webmanifest')).name, 'BuildMaster Elite Tático v31.76');

console.log('v31.76 integração de produção limpa aprovada.');
