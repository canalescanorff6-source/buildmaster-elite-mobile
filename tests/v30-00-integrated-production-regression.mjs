...
assert.equal(JSON.parse(read('public/manifest.webmanifest')).name, 'BuildMaster Elite Tático v31.74');

console.log('v31.74 integração de produção limpa aprovada.');
