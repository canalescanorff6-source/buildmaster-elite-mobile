...
expect(preflight.includes('Marques Fichas v31.78'), 'Pré-voo não valida o manifesto PWA da v31.78.');
...
expect(manifest.name === 'Marques Fichas v31.78' && manifest.short_name === 'Marques Fichas', 'Manifesto PWA não está na v31.78.');
expect(serviceWorker.includes('marques-fichas-v31-78'), 'Cache PWA não foi renovado para v31.78.');
