...
assert.match(cache, /NATIVE_CACHE_SCHEMA = '(?:37|38)\.\d+\.0-[^']+-1'/,
...
assert.ok(v33.includes('38\\.(?:00|10|20|30|31|32|33|34|35|36|37|38)'),
  'A regressão v33 precisa aceitar o esquema ativo da v38.38.');
