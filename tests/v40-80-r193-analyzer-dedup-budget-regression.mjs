...
assert.ok(sourceBytes <= (r443CatalogBoundary ? 5_832_704 : r2004Boundary ? 5_360_000 : 5_344_000), `R193: redução líquida foi perdida; src TS/TSX voltou a ${sourceBytes} bytes.`);
