...
assert.ok(/^38\.(?:34|35)\.0$/.test(pkg.version), `Versão compatível esperada: ${pkg.version}`);
...
console.log('v38.34 preservada na v38.35: orçamento protegido, rota inicial restaurada e contrato do gerador compatível com o Estúdio Marques.');
