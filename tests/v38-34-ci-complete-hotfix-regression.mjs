...
assert.ok(/^38\.(?:34|35|36|37)\.0$/.test(pkg.version), `Versão compatível esperada: ${pkg.version}`);
...
console.log('v38.34 preservada na v38.37: orçamento protegido, rota inicial restaurada e contrato do gerador compatível com o Estúdio Marques.');
