...
assert.ok(r60 >= 0 && r60 < r108 && r108 < masterIndex && masterIndex < r80 && r80 < r118 && r118 < r90 && r90 < r119 && r119 < r100);
...
console.log('r100 aprovada: Identidade R60 -> Card Signature R108 -> auditorias read-only -> r119 -> Produção read-only, com autoridade única Clean Slate.');
