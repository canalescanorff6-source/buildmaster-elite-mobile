...
assert.match(workflow, /v27\.28/);
assert.match(panel, /Detalhe técnico|histórico técnico/i);

console.log('✓ v27.28: diagnóstico do atualizador, histórico técnico, recuperação em três rodadas e interface responsiva aprovados.');
