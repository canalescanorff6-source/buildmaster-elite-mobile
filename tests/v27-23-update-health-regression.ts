...
assert.match(workflow, /v27\.24/);
assert.match(workflow, /diagnóstico|histórico técnico/i);

console.log('✓ v27.24: diagnóstico do atualizador, histórico técnico, recuperação em três rodadas e interface responsiva aprovados.');
