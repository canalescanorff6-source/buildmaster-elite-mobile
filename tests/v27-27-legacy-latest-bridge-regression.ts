...
assert.match(pkg.scripts['test:all'], /^npm run test:v2738 && npm run test:v2737 && npm run test:v2736 && npm run test:v2735 && npm run test:v2734 && npm run test:v2733 && npm run test:v2729 && npm run quality:audit && npm run test:v2728 && npm run test:v2727 &&/);
assert.equal(
  DEFAULT_UPDATE_MANIFEST_URL,
