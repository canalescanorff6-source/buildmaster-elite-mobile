...
assert.match(readerRuntime,/readEightEfhubCalibrationMacros/);
assert.match(readerRuntime,/calibratedFastPath[\s\S]*?zones: \[\]/);
assert.match(reader,/MANUAL_CALIBRATION_FAST_READER_VERSION = '40\.20-nine-macros-r2'/);
assert.match(readerRuntime,/buildPreciseOcrZonesFromEfhubCalibration/);
