...
assert.match(nativeCache, /NATIVE_CACHE_SCHEMA = '38\.(?:31\.0-ci-regression-hotfix|32\.0-complete-integration|33\.0-professional-template|34\.0-ci-stability|35\.0-legacy-regressions|36\.0-deterministic-audit|38-(?:37-automatic-card-gameplay|38-legacy-profile-regressions))-1'/);
...
assert.ok(v3771.includes('37\\.0-automatic-card-gameplay'), 'A regressão v37.71 precisa aceitar o cache v38.38.');
