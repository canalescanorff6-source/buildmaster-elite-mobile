...
assert.match(component, /type SettingsView = 'evolucao' \| 'experiencia' \| 'aparencia' \| 'desempenho' \| 'seguranca' \| 'suporte' \| 'comunidade' \| 'comercial' \| 'publicacao' \| 'backup' \| 'atualizacoes' \| 'contas'/);
