...
assert.match(result.buildName, /Ficha Automática v(?:38\.40|40\.(?:00|10|20|30|40|50|60|70))/, 'O nome deve manter o contrato público e identificar o Motor Supremo no complemento.');
