...
const analyzerCardEvidence=read('src/modules/analysis/analyzerCardEvidenceR186.ts');
const cardEvidenceParser=read('src/modules/analysis/cardEvidenceParserR130.ts');
...
assert.match(cardEvidenceParser,/function detectImpetoSlotStatus/,'R130 moveu a leitura do slot de Ímpeto para o parser de evidência; o agregador não pode exigir retorno ao monólito.');
assert.match(analyzerCardEvidence,/impetoSlotStatus: impetoSlot\.status/,'Ímpeto deve permanecer propagado pela fronteira canônica de evidência R186.');
