...
pass(pkg.version === '29.20.0', 'Pacote final preserva a base v29.10');
...
pass(globals.trim().endsWith('@import "./design-system-v2920-production.css";'), 'Estilo v29.10 é a última camada visual');
pass(layout.includes('bm-v2910-admin-update'), 'Escopo visual v29.10 está ativo no layout');
pass(dataSafety.includes('CURRENT_DATA_SCHEMA = 2920') && dataSafety.includes("APP_DATA_VERSION = '29.20.0'"), 'Backup foi elevado sem remover seções anteriores');
