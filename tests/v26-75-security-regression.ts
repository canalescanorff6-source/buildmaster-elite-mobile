...
async function main() {
  ...
  const apkUrl = 'https://github.com/canalescanorff6-source/buildmaster-elite-mobile/releases/download/buildmaster-latest/BuildMaster-Elite-Tatico-latest.apk';
  ...
  const manifest = {
    ...
    version: '26.76.0', buildId: 'abc', publishedAt: new Date().toISOString(), channel: 'stable' as const,
    updateType: 'apk' as const, apkUrl, notes: [], mandatory: true, minNativeVersion: '26.75.0', checksum: 'a'.repeat(64)
  };
