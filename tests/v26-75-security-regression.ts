...
async function main() {
  ...
  const apkUrl = 'https://github.com/canalescanorff6-source/buildmaster-elite-mobile/releases/download/buildmaster-latest/BuildMaster-Elite-Tatico-v27.20.0-1352000001-abcdef12.apk';
  ...
  const manifest = {
    ...
    version: '27.20.0', versionCode: 1352000001, buildId: 'abc', publishedAt: new Date().toISOString(), channel: 'stable' as const,
    updateType: 'apk' as const, apkUrl: 'https://github.com/canalescanorff6-source/buildmaster-elite-mobile/releases/download/buildmaster-latest/BuildMaster-Elite-Tatico-v27.20.0-1352000001-abcdef12.apk', notes: [], mandatory: true, minNativeVersion: '26.75.0', checksum: 'a'.repeat(64), sizeBytes: 123
  };
