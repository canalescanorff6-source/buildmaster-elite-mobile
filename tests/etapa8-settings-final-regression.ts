...
assert.match(app, /type SettingsView = 'evolucao' \| 'experiencia' \| 'aparencia' \| 'desempenho' \| 'seguranca' \| 'suporte' \| 'comunidade' \| 'comercial' \| 'publicacao' \| 'backup' \| 'atualizacoes' \| 'contas'/);
