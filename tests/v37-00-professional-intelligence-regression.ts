...
const matches: MatchValidationRecord[] = [
  {
    id: 'm1', cardFingerprint: exactCardFingerprint, playerName: result.parsed.playerName, targetPosition: result.bestPosition.code, formation: '4-2-2-2', teamStyle: 'POSSE_DE_BOLA', buildName: result.buildName, buildSignature: 'b', playedAt: '2026-07-30T10:00:00.000Z', minutes: 90,
  ...
  {
    id: 'm2', cardFingerprint: exactCardFingerprint, playerName: result.parsed.playerName, targetPosition: result.bestPosition.code, formation: '4-3-3', teamStyle: 'CONTRA_ATAQUE_RAPIDO', buildName: result.buildName, buildSignature: 'b', playedAt: '2026-07-31T10:00:00.000Z', minutes: 90,
  ...
  {
    id: 'm3', cardFingerprint: exactCardFingerprint, playerName: result.parsed.playerName, targetPosition: result.bestPosition.code, formation: '4-1-2-3', teamStyle: 'POSSE_DE_BOLA', buildName: result.buildName, buildSignature: 'b', playedAt: '2026-08-01T10:00:00.000Z', minutes: 90,
...
assert.equal(positions.selected.position, result.bestPosition.code, 'A matriz profissional deve seguir a posição automática canônica R417, não o alvo manual.');
