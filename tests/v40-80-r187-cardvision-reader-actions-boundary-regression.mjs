...
assert.equal(crypto.createHash('sha256').update(r119).digest('hex'), 'bc888d06abb39827b43dc1cb260a3d57db57c0f18321014e3cd4e34a1c126704', 'R187: R119 não pode mudar durante modularização do leitor.');
