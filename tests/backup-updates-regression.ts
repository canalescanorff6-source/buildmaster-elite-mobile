...
assert.equal(APP_DATA_VERSION, '26.70.0');
assert.equal(APP_RELEASE_VERSION, '26.70.0');
assert.equal(compareVersions('26.70.1', '26.70.0'), 1);
assert.equal(compareVersions('26.70.0', '26.70.0'), 0);
assert.equal(compareVersions('26.69.9', '26.70.0'), -1);
...
assert.equal(evaluateUpdateManifest(manifest, '26.70.0', 'old-build').available, true);
assert.equal(evaluateUpdateManifest({ ...manifest, version: '26.70.0', buildId: 'old-build' }, '26.70.0', 'old-build').available, false);
assert.equal(evaluateUpdateManifest({ ...manifest, appId: 'outro.app' }, '26.70.0', 'old-build').valid, false);
...
console.log('✓ Backup dedicado e Central de Atualizações v26.70 validados.');
