...
assert.equal(APP_DATA_VERSION, '27.39.0');
assert.equal(APP_RELEASE_VERSION, '27.39.0');
assert.equal(compareVersions('27.1.0', '27.39.0'), -1);
assert.equal(compareVersions('27.39.0', '27.39.0'), 0);
assert.equal(compareVersions('26.99.9', '27.39.0'), -1);
...
assert.equal(evaluateUpdateManifest(manifest, { versionName: '27.39.0', versionCode: 1350900010 }, 'old-build').available, true);
assert.equal(evaluateUpdateManifest({ ...manifest, version: '27.39.0', versionCode: 1350900010, buildId: 'old-build' }, { versionName: '27.39.0', versionCode: 1350900010 }, 'old-build').available, false);
assert.equal(evaluateUpdateManifest({ ...manifest, appId: 'outro.app' }, { versionName: '27.39.0', versionCode: 1350900010 }, 'old-build').valid, false);
