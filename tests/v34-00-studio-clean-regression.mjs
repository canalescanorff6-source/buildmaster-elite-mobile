...
const app = `${read('src/components/CardVisionApp.tsx')}\n${read('src/hooks/useCardVisionCentralWorkspaceR175.ts')}\n${read('src/modules/core/centralSafeViewR130.ts')}`;
...
assert.match(navigation, /(?:Studio Premium · v34\.00|Performance Suite · v36\.00|Professional Suite · v(?:37\.00|38\.(?:3[2-9]|40)|40\.(?:00|10|20|30|40|50|60|70|80)))/);
