...
assert.ok(sourceBytes <= (postCatalogBoundary ? 5_832_704 : r2004Boundary ? 5_360_000 : r200Boundary ? 5_341_000 : 5_335_500), `R197: redução líquida perdida; src voltou a ${sourceBytes} bytes.`);
