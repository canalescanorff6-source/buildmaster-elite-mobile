...
assert.match(calibrator, /Arraste os 10 quadrados/);
assert.match(calibrator, /Restaurar os 10 quadrados/);
...
console.log('r31 aprovada: 9º quadrado de progressão + 10º quadrado especial + reconstrução da ficha automática + Top 5 por função real do meia.');
