...
assert.match(session.canonicalText, /LEITURA DETALHADA V30\.50/);
...
assert.match(panel, /Leitura detalhada v30\.50/);
...
assert.match(css, /BuildMaster v30\.50 — leitura detalhada/);
assert.match(css, /BuildMaster v30\.50 — inteligência profunda/);
...
console.log('v30.50 leitura detalhada e Inteligência Profunda da Carta aprovadas.');
