...
assert.match(readerRuntime, /refineSinglePrintGeometryFromText/, 'A geometria refinada continua obrigatória no runtime canônico do Leitor R163.');
assert.match(readerRuntime, /Perfil eFHUB (?:encaixado|padronizado)/, 'O runtime canônico precisa continuar reportando o perfil eFHUB aplicado.');
...
console.log('v31.10 leitura detalhada e Inteligência Profunda da Carta aprovadas.');
