...
assert.match(workflow, /Gerar APK v27\.28 e publicar atualização automática em três canais/);
...
console.log('✓ v27.28: canal imutável moderno e ponte latest compatível com o APK v27.00 aprovados.');
