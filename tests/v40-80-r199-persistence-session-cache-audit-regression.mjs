...
assert.ok(sourceBytes <= (postCatalogBoundary ? 5_667_168 : r200Boundary ? 5_360_000 : 5_335_307), `R199/R200: orçamento de fonte excedeu a margem aprovada (${sourceBytes} B).`);
