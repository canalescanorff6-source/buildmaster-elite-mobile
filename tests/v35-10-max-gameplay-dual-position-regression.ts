...
assert.match(natural.buildName, /^(?:Ficha v35 Máxima|Ficha Automática v38\.(?:37|38|39|40))/);
assert.match(selected.buildName, /^(?:Ficha v35 Máxima|Ficha Automática v38\.(?:37|38|39|40))/);
