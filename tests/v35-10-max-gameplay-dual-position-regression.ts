...
assert.match(natural.buildName, /^(?:Ficha v35 Máxima|Ficha Automática v(?:38\.(?:37|38|39|40)|40\.(?:00|10|20)))/);
assert.match(selected.buildName, /^(?:Ficha v35 Máxima|Ficha Automática v(?:38\.(?:37|38|39|40)|40\.(?:00|10|20)))/);
