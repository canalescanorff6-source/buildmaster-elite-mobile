...
assert.match(budget, /sourceTs:\s*(?:3\.5|4)\s*\*\s*1024\s*\*\s*1024/);
const sourceBudgetMatch = budget.match(/sourceTs:\s*(3\.5|4)\s*\*\s*1024\s*\*\s*1024/);
assert.ok(sourceBudgetMatch && Number(sourceBudgetMatch[1]) <= 4, 'O teto TypeScript não pode ultrapassar 4 MiB sem modularização.');
