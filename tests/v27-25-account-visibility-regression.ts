...
assert.match(css, /v27\.26 — acesso visível para criação e administração de contas/);
...
console.log('✓ v27.26: opção Criar contas visível, acesso direto do administrador e proteção MFA preservados.');
