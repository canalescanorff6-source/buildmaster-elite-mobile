...
assert.match(css, /v27\.25 — acesso visível para criação e administração de contas/);
...
console.log('✓ v27.25: opção Criar contas visível, acesso direto do administrador e proteção MFA preservados.');
