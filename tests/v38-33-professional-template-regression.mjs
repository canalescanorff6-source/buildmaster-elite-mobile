...
assert.equal(poster.PROFESSIONAL_TACTICAL_TEMPLATE_VERSION, '38.34.0');
...
console.log('v38.34 Gerador Tático Profissional aprovado: template determinístico, 11 jogadores, setas controladas, painéis completos, PNG/PDF e compatibilidade sem IA paga.');
