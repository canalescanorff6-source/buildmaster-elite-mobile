...
assert.equal(evaluateUpdateManifest(manifest, { versionName: '28.80.0', versionCode: 1350900010 }, 'old').available, true);
assert.equal(evaluateUpdateManifest({ ...manifest, version: '28.80.0', versionCode: 1350900010 }, { versionName: '28.80.0', versionCode: 1350900010 }, 'abcdef123456').available, false);
assert.equal(evaluateUpdateManifest({ ...manifest, versionCode: 1350809999 }, { versionName: '28.80.0', versionCode: 1350900010 }, 'old').available, false);
