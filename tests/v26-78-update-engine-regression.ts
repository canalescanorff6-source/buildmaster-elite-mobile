...
assert.equal(evaluateUpdateManifest(manifest, { versionName: '27.36.0', versionCode: 1350900010 }, 'old').available, true);
assert.equal(evaluateUpdateManifest({ ...manifest, version: '27.36.0', versionCode: 1350900010 }, { versionName: '27.36.0', versionCode: 1350900010 }, 'abcdef123456').available, false);
assert.equal(evaluateUpdateManifest({ ...manifest, versionCode: 1350809999 }, { versionName: '27.36.0', versionCode: 1350900010 }, 'old').available, false);
