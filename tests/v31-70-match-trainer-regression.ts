...
assert.equal(MATCH_TRAINER_VERSION, '31.70.0');
...
assert.match(report, /TREINADOR DE PARTIDAS v31\.70/);
...
console.log('v31.70 motor de sessões, marcadores, resumo e relatório aprovado.');
