...
assert.match(panel, /rascunho salvo automaticamente/);
...
assert.match(library, /MAX_PROJECTS = 40/);
...
console.log('v27.33: Estúdio Tático completo, biblioteca, editor, formatos e atualizador Android preservados.');
