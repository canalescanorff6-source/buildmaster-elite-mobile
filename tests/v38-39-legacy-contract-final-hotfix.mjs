...
assert.match(sw, /buildmaster-(?:v38-(?:39-legacy-contract-final|40-background-ocr-resume)-1|v40-(?:00-card-reader-rebuild|10-progress|20-progress)-1)/);
assert.match(nativeCache, /(?:38\.(?:39\.0-legacy-contract-final|40\.0-background-ocr-resume)-1|40\.(?:(?:00|10)\.0-fail-open-startup|20\.0-progress-runtime)-1)/);
