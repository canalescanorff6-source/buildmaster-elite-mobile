...
const engine = fs.readFileSync('legacy-src/lib/supremePerformanceEngineV3870.ts', 'utf8');
...
const panel = fs.readFileSync('legacy-src/components/SupremePerformanceV3870Panel.tsx', 'utf8');
...
assert.doesNotMatch(workspace, /SupremePerformanceV3870Panel/);
