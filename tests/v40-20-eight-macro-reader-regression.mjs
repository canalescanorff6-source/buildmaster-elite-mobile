...
assert.match(reader,/mapa atual possui nove quadrados primários/i);
assert.match(progress,/deadlineMs\?: number/);
assert.match(progress,/safeRemaining/);
console.log('v40.30 aprovada: OCR BEST descompactado, 9 macros primários, teto de 90 s e ETA não explosiva.');
