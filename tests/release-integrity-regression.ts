...
assert.equal(pkg.version, '27.35.0', 'package.json precisa estar na v27.35.0');
...
assert.ok(manifest.includes('v27.35'), 'manifest.webmanifest não corresponde à v27.35.');
assert.ok(sw.includes('27-35'), 'Cache do service worker não corresponde à v27.35.');
...
console.log('release integrity v27.35: assinatura, APK único, manifesto e verificação pós-publicação alinhados.');
