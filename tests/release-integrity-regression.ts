...
assert.equal(pkg.version, '27.36.0', 'package.json precisa estar na v27.36.0');
...
assert.ok(manifest.includes('v27.36'), 'manifest.webmanifest não corresponde à v27.36.');
assert.ok(sw.includes('27-36'), 'Cache do service worker não corresponde à v27.36.');
...
console.log('release integrity v27.36: assinatura, APK único, manifesto e verificação pós-publicação alinhados.');
