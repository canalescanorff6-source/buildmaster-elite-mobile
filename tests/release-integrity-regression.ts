...
assert.equal(pkg.version, '27.29.0', 'package.json precisa estar na v27.29.0');
...
assert.ok(manifest.includes('v27.29'), 'manifest.webmanifest não corresponde à v27.29.');
assert.ok(sw.includes('27-29'), 'Cache do service worker não corresponde à v27.29.');
...
console.log('release integrity v27.29: assinatura, APK único, manifesto e verificação pós-publicação alinhados.');
