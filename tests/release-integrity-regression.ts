...
assert.equal(pkg.version, '27.38.0', 'package.json precisa estar na v27.38.0');
...
assert.ok(manifest.includes('v27.38'), 'manifest.webmanifest não corresponde à v27.38.');
assert.ok(sw.includes('27-38'), 'Cache do service worker não corresponde à v27.38.');
...
console.log('release integrity v27.38: assinatura, APK único, manifesto e verificação pós-publicação alinhados.');
