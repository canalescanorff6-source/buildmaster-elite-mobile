...
assert.equal(pkg.version, '27.39.0', 'package.json precisa estar na v27.39.0');
...
assert.ok(manifest.includes('v27.39'), 'manifest.webmanifest não corresponde à v27.39.');
assert.ok(sw.includes('27-39'), 'Cache do service worker não corresponde à v27.39.');
...
console.log('release integrity v27.39: assinatura, APK único, manifesto e verificação pós-publicação alinhados.');
