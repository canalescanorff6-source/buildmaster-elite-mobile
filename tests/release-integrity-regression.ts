...
assert.equal(pkg.version, '27.10.0', 'package.json precisa estar na v27.10.0');
...
assert.ok(layout.includes('v27.10'), 'Metadados da interface não correspondem à v27.10.');
assert.ok(manifest.includes('v27.10'), 'manifest.webmanifest não corresponde à v27.10.');
assert.ok(sw.includes('27-10'), 'Cache do service worker não corresponde à v27.10.');
...
console.log('release integrity v27.10: assinatura, APK único, manifesto e verificação pós-publicação alinhados.');
