...
for (const marker of ['Sobreposição','Formação fluída','duas Combinações','Dedicação defensiva','Interceptação','Domínio e recepção']) assert.ok(season.includes(marker),`catálogo v6 sem ${marker}`);
