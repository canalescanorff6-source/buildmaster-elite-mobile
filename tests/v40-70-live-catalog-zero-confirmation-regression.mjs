...
for (const marker of ['Todos por Um','Formação fluída','duas Combinações','Dedicação defensiva','Interceptação','Domínio e recepção']) assert.ok(season.includes(marker),`catálogo v6 sem ${marker}`);
assert.doesNotMatch(season,/Sobreposição/,'nome legado Sobreposição não deve retornar no catálogo v6');
