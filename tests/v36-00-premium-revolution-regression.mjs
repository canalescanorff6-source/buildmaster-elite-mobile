...
assert.match(manifest.name, /v(?:37\.00|38\.(?:3[2-9]|40)|40\.(?:00|10|20|30|40|50|60|70))/);
...
assert.match(navigation, /Professional Suite · v(?:37\.00|38\.(?:3[2-9]|40)|40\.(?:00|10|20|30|40|50|60|70))/);
