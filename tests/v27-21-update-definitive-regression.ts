...
const releaseTag = 'buildmaster-v27.25.0-1352300043-01';
const apkName = 'BuildMaster-Elite-Tatico-v27.25.0-135230004301-acde1234.apk';
const manifestName = 'update-manifest-v27.25.0-1352300043.json';
...
assert.equal(isTrustedApkUrl(apkUrl.replace(releaseTag, 'buildmaster-v27.25.0-malicioso')), false);
...
console.log('✓ v27.25: canal direto, release imutável, API reserva, quatro tentativas e instalador reforçado aprovados.');
