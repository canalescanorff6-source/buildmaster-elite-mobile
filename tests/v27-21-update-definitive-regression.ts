...
const releaseTag = 'buildmaster-v27.21.0-1352100043-01';
const apkName = 'BuildMaster-Elite-Tatico-v27.21.0-135210004301-acde1234.apk';
const manifestName = 'update-manifest-v27.21.0-1352100043.json';
...
assert.equal(isTrustedApkUrl(apkUrl.replace(releaseTag, 'buildmaster-v27.21.0-malicioso')), false);
...
assert.match(workflow, /release imutável, API latest e canal de compatibilidade validados/);
...
assert.match(panel, /fallback oficial/i);
...
console.log('✓ v27.21: API latest, release imutável, fallback antigo, quatro tentativas e instalador reforçado aprovados.');
