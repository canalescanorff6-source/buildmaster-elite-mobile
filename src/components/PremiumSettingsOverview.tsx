  ...
  return (
    <section className="bm32-settings-overview" aria-label="Configurações">
      <header className="bm32-screen-heading">
        ...
        <div><h1>Configurações</h1><p>Personalize sua experiência e mantenha seus dados protegidos.</p></div>
      </header>

      <section className="bm32-premium-banner"><span><Crown size={31}/></span><div><h2>Modo Premium <em>ATIVO</em></h2><p>Aproveite todos os recursos exclusivos do BuildMaster Elite Tático.</p></div><button type="button" onClick={() => onOpen('contas')}>Gerenciar <ChevronRight size={19}/></button></section>
      ...
      <div className="bm32-about-line"><Info size={17}/><span>BuildMaster Elite Tático • v{version}</span></div>
    </section>
  );
}
