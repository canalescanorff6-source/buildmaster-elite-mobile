  ...
  return (
    <section className="bm32-menu-screen" aria-label="Menu">
      <header className="bm32-screen-heading">
        ...
        <div><h1>Menu</h1><p>Acesso rápido a todos os módulos do BuildMaster.</p></div>
      ...
      <section className="bm32-plan-callout"><Crown size={28}/><div><strong>Você está no plano Elite</strong><span>Aproveite todos os recursos premium do BuildMaster.</span></div><button type="button" onClick={() => onNavigate('accounts')}>Ver benefícios <ChevronRight size={18}/></button></section>
