...
export function AccountAdminPanel() {
  ...
  const mfaRequired = true; // R424-fix2: administração sempre fail-closed com MFA.
  ...
  return (
    <div className="account-admin-workspace account-admin-final-workspace">
      <section className="account-admin-panel luxury-panel settings-view-panel settings-final-panel">
        ...
        <div className="account-setup-warning"><CheckCircle2 size={20} /><div><strong>{backendHealth.message}</strong><span>Perfis: {backendHealth.profileCount} • Clientes: {backendHealth.userCount} • MFA: obrigatório.</span></div></div>
        <div className="account-license-grid account-license-premium-grid">
