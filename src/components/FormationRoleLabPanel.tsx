  ...
  return (
    <section className="formation-role-lab">
      <article className="formation-lab-hero luxury-panel">
        <div><p className="kicker"><Sparkles size={15}/> v27.38 • Meta eFootball 2026</p><h3>Formações com estilos oficiais e regras competitivas</h3><p>O técnico usa somente Posse de bola, Contra-ataque rápido ou Contra-ataque normal. Cada jogador mantém o estilo oficial da carta e recebe a avaliação Meta 2026.</p></div>
