...
export const LOCAL_CARD_RULES: LocalCardRule[] = [
  { id: 'edgar-davids', match: ['edgar davids', 'davids', 'e. davids'], mainPosition: 'DMF', playstyle: 'Destruidor', bestPositions: ['DMF', 'CMF', 'CB'], avoidPositions: ['LB', 'RB', 'LWF', 'RWF', 'CF', 'SS', 'GK'], note: 'Regra local: Davids é destruidor central; mesmo com LE/LD alto no grid, o foco competitivo deve ser VOL/MLG.' },
  { id: 'gattuso', match: ['gattuso', 'g. gattuso', 'gennaro gattuso'], mainPosition: 'DMF', playstyle: 'Destruidor', bestPositions: ['DMF', 'CMF', 'CB'], avoidPositions: ['LB', 'RB', 'LWF', 'RWF', 'CF', 'SS'], note: 'Regra local: destruidor rende melhor centralizado como VOL/MLG, não como lateral ou atacante.' },
  ...
  { id: 'vieira', match: ['vieira', 'patrick vieira'], mainPosition: 'DMF', playstyle: 'Destruidor', bestPositions: ['DMF', 'CMF'], avoidPositions: ['LB', 'RB', 'CF', 'SS', 'LWF', 'RWF'], note: 'Regra local: volante físico de pressão e interceptação.' },
  ...
  { id: 'kante', match: ['kante', 'kanté', 'n. kante', 'n golo kante'], mainPosition: 'DMF', playstyle: 'Destruidor', bestPositions: ['DMF', 'CMF'], avoidPositions: ['CF', 'SS', 'LWF', 'RWF', 'GK'], note: 'Regra local: motor de pressão central, não lateral ou atacante.' },
  ...
  { id: 'cristiano-ronaldo', match: ['cristiano ronaldo', 'c. ronaldo', 'ronaldo'], mainPosition: 'CF', playstyle: 'Artilheiro', bestPositions: ['CF', 'LWF'], avoidPositions: ['CB', 'DMF', 'LB', 'RB', 'GK'], note: 'Regra local: finalização, ataque ao espaço e jogo aéreo.' },
  { id: 'haaland', match: ['haaland', 'erling haaland', 'e. haaland'], mainPosition: 'CF', playstyle: 'Artilheiro', bestPositions: ['CF'], avoidPositions: ['AMF', 'CMF', 'DMF', 'CB', 'LB', 'RB', 'GK'], note: 'Regra local: centroavante de área; não converter por GER lateral/meia.' },
