...
export const FORMATION_ROLE_CATALOG: Record<FormationRoleId, FormationRole> = {
  ...
  'classico-10': { id:'classico-10', officialName:'Clássico nº 10', positions:['AMF','CMF'], purpose:'Organizar o ataque em ritmo controlado.', strengths:['Passe','Controle de bola','Posicionamento'] },
  'infiltracao': { id:'infiltracao', officialName:'Jogador de infiltração', positions:['AMF','SS'], usablePositions:['CMF','LMF','RMF'], purpose:'Atacar espaço sem bola e chegar na área.', strengths:['Aceleração','Talento ofensivo','Finalização'] },
  ...
  'primeiro-volante': { id:'primeiro-volante', officialName:'Primeiro volante', positions:['DMF'], purpose:'Fixar à frente da defesa e proteger a zona central.', strengths:['Consciência defensiva','Desarme','Posicionamento'] },
  'volante-destruidor': { id:'volante-destruidor', officialName:'O destruidor', positions:['DMF','CMF'], purpose:'Saltar na pressão e interromper transições.', strengths:['Agressividade','Desarme','Contato físico'] },
  ...
  'zagueiro-destruidor': { id:'zagueiro-destruidor', officialName:'O destruidor', positions:['CB'], purpose:'Antecipar, combater e dominar o duelo físico.', strengths:['Agressividade','Desarme','Contato físico'] },
