...
export const IMPETO_FUNCTIONAL_MATRIX_R119: ImpetoFunctionalProfileR119[] = [
  ...
  p('Cobrança de falta',{nature:'creative',domains:{finishing:.55,passing:.45},actions:{set_piece:1,long_finish:.32,through_creation:.22},positions:{AMF:1,CMF:.88,SS:.82,LWF:.72,RWF:.72},attributes:['placeKicking','curl','kickingPower'],explanation:'Bola parada, curva e precisão.'}),
