...
type Enriched = AnalysisResult & { masterCardV4080R50?: MasterShape; canonicalCardIdentity2027R60?: CanonicalCardIdentityR60; performanceEngine2027R108?: PerformanceEngine2027R108 };
...
export function applyPermanentResources2027R80(result:AnalysisResult):WithR80{
  ...
  const confidence=clamp((canonical(result)?.identityConfidence??72)*0.45+(r108(result)?.confidence??70)*0.35+(top5.length===5?100:65)*0.2);
