...
export const PLAY_STORE_PUBLICATION_VERSION = '38.37.0';
...
export function buildPlayStorePublicationReport(profileInput: unknown, now = new Date()): PlayStorePublicationReport {
  ...
  const checks: PublicationCheck[] = [
    ...
    check('releaseNotesReady', 'distribuição', 'Notas da versão', 'Notas pt-BR da v38.37 incluídas no pacote da loja.', profile.releaseNotesReady),
