...
export const PLAY_STORE_PUBLICATION_VERSION = '30.20.0';
...
export function buildPlayStorePublicationReport(profileInput: unknown, now = new Date()): PlayStorePublicationReport {
  ...
  const checks: PublicationCheck[] = [
    ...
    check('releaseNotesReady', 'distribuição', 'Notas da versão', 'Notas pt-BR da v30.20 incluídas no pacote da loja.', profile.releaseNotesReady),
