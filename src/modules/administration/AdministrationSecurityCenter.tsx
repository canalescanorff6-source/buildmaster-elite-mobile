    ...
    <section className="admin-security-center luxury-panel settings-view-panel settings-final-panel" aria-label="Administração e segurança avançada">
      ...
      <div className="bm2910-admin-columns">
        <section className="bm2910-security-policy">
          ...
          <label><span>Versão mínima permitida</span><input value={settings.minAppVersion} onChange={(event) => setSettings((current) => ({ ...current, minAppVersion: event.target.value.replace(/^v/i, '') }))} inputMode="decimal" placeholder="29.20.0" /><small>Elevar esta versão bloqueia APKs antigos na validação de licença.</small></label>
