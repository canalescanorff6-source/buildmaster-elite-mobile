...
const MAX_MODULES_R159 = 248;
const MAX_SOURCE_BYTES_R159 = 3_620_000;
...
if (seen.size > MAX_MODULES_R159) throw new Error(`R159: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R159}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R159) throw new Error(`R159: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R159}).`);
console.log(`R159 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
