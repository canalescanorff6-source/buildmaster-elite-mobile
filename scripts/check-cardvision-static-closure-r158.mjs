...
const MAX_MODULES_R158 = 258;
const MAX_SOURCE_BYTES_R158 = 3_700_000;
...
if (seen.size > MAX_MODULES_R158) throw new Error(`R158: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R158}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R158) throw new Error(`R158: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R158}).`);
console.log(`R158 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
