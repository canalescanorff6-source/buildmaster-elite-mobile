...
export const R427_BUILD_PIPELINE_REPAIR_VERSION = '40.80-r450-r427-forward-compatible-v2';
...
export function auditR427BuildPipelineContracts(sourceR407, sourceR420) {
  const r407Ok = sourceR407.includes('const sourceBudget=5.5*1024*1024;');
...
export function patchR420SavedAnalysisImportR427(source) {
  ...
  const semantic = auditR427BuildPipelineContracts('const sourceBudget=5.5*1024*1024;', source);
...
export function applyR427BuildPipelineRepair(rootDirectory = process.cwd()) {
  ...
  if (!audit.ok) {
    const missing = [];
    if (!audit.r407Ok) missing.push('R407 5,5 MiB');
