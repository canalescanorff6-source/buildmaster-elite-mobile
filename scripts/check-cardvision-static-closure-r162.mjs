...
const MAX_MODULES_R162 = 214;
const MAX_SOURCE_BYTES_R162 = 3_240_000;
...
if (seen.size > MAX_MODULES_R162) throw new Error(`R162: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R162}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R162) throw new Error(`R162: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R162}).`);
console.log(`R162 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
