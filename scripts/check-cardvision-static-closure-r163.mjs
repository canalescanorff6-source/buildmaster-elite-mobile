...
const MAX_MODULES_R163 = 213;
const MAX_SOURCE_BYTES_R163 = 3_205_000;
...
if (seen.size > MAX_MODULES_R163) throw new Error(`R163: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R163}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R163) throw new Error(`R163: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R163}).`);
console.log(`R163 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
