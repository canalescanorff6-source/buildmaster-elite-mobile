...
const svg = createTacticalPosterSvg({
  ...
  subtitle: `${formation.name} • Base curta • v27.33`,
  focus: 'Segurança, construção curta, compactação e finalização inteligente.',
  formation,
  lineup,
  style,
  palette: 'ouro',
...
fs.writeFileSync('docs/current/AMOSTRA_ESTUDIO_TATICO_V27_33.svg', svg);
console.log('Amostra SVG v27.33 gerada.');
