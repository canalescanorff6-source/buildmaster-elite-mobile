...
function replaceRequired(source, needle, replacement, label) {
  ...
  if (!source.includes(needle)) throw new Error(`[r20] ${label}: contrato de origem não encontrado.`);
...
export function transformPreFinalAutofillR20(input) {
  ...
  source = replaceRequired(source, oldBlock, newBlock, 'preenchimento automático de Nome/Nível/Pontos');
