...
const MAX_MODULES_R160 = 230;
const MAX_SOURCE_BYTES_R160 = 3_380_000;
...
if (seen.size > MAX_MODULES_R160) throw new Error(`R160: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R160}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R160) throw new Error(`R160: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R160}).`);
console.log(`R160 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
