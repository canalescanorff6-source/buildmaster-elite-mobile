...
const MAX_MODULES_R161 = 216;
const MAX_SOURCE_BYTES_R161 = 3_280_000;
...
if (seen.size > MAX_MODULES_R161) throw new Error(`R161: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R161}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R161) throw new Error(`R161: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R161}).`);
console.log(`R161 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
