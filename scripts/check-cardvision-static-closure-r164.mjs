...
const MAX_MODULES_R164 = 210;
const MAX_SOURCE_BYTES_R164 = 3_155_000;
...
if (seen.size > MAX_MODULES_R164) throw new Error(`R164: árvore estática cresceu para ${seen.size} módulos (limite ${MAX_MODULES_R164}).`);
if (sourceBytes > MAX_SOURCE_BYTES_R164) throw new Error(`R164: árvore estática cresceu para ${sourceBytes} bytes (limite ${MAX_SOURCE_BYTES_R164}).`);
console.log(`R164 static closure aprovado: ${seen.size} módulos, ${sourceBytes} bytes de fonte estática.`);
