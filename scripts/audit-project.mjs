...
check(pkg.version === '32.00.0', 'Versão atual configurada', pkg.version);
check(appUpdates.includes("'32.00.0'"), 'Motor de atualização sincronizado');
check(dataSafety.includes("APP_DATA_VERSION = '32.00.0'") && dataSafety.includes('CURRENT_DATA_SCHEMA = 3000'), 'Esquema de dados sincronizado');
check(manifest.name === 'BuildMaster Elite Tático v32.00', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v32-00'), 'Cache PWA sincronizado');
