...
check(/^27\.36\.\d+$/.test(expectedVersion), 'Versão de auditoria v27.36 configurada', `encontrada ${expectedVersion}`);
...
check(sw.includes('27-36'), 'Cache do service worker foi renovado');
