...
check(pkg.version === '35.20.0', 'Versão atual configurada', pkg.version);
check(appUpdates.includes("'35.20.0'"), 'Motor de atualização sincronizado');
check(dataSafety.includes("APP_DATA_VERSION = '35.20.0'") && dataSafety.includes('CURRENT_DATA_SCHEMA = 3000'), 'Esquema de dados sincronizado');
check(manifest.name === 'BuildMaster Elite Tático v35.20', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v35-20'), 'Cache PWA sincronizado');
