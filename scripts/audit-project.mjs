...
check(/^27\.35\.\d+$/.test(expectedVersion), 'Versão de auditoria v27.35 configurada', `encontrada ${expectedVersion}`);
...
check(sw.includes('27-35'), 'Cache do service worker foi renovado');
