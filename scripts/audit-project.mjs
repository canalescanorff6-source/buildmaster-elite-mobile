...
check(manifest.name === 'BuildMaster Elite Tático v31.78', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-78'), 'Cache PWA sincronizado');
