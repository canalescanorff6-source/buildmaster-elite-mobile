...
export function sanitizeUpdateSource(rootDirectory=process.cwd()){
  ...
  if(modern){
    ...
    console.log(`v40.80 r446: autorreparo pós-catálogo protegido (${r446.patched.length} patcher(s) atualizado(s)); Cofre R414 preservado.`);
    return {
      modernTree:true,
      sourcePatched:r446.changed||r404.sourceChanged||r405.sourceChanged||r406.sourceChanged||r406fix4.changed||r406fix5.sourceChanged||r407.sourceChanged||r408.sourceChanged||r409.sourceChanged||r410.sourceChanged||r411.sourceChanged||r412.sourceChanged||r413.sourceChanged||r414.sourceChanged,
      r446,r404,r405,r406,r406fix2,r406fix3,r406fix4,r406fix5,r406fix7,r407,r408,r409,r410,r411,r412,r413,r414
    };
  }
