...
check(version === '30.00.0', 'Versão v30.00 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v30.00' && manifest.short_name === 'BuildMaster v30.00', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v30-00'), 'Cache PWA renovado');
...
check(pkg.scripts?.['test:all'] === 'npm run test:v3000 && npm run quality:audit', 'Bateria atual configurada');
