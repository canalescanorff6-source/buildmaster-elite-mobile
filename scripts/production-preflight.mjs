...
check(version === '40.20.0', 'Versão v40.20 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v40.20' && manifest.short_name === 'BuildMaster v40.20', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v40-20-progress-1'), 'Cache PWA v40.20 renovado');
