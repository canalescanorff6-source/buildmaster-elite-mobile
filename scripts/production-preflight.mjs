...
check(version === '31.78.0', 'Versão v31.78 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.78' && manifest.short_name === 'BuildMaster v31.78', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-78'), 'Cache PWA renovado');
