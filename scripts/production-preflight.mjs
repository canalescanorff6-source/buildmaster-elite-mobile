...
check(!/@import\s+['"]/i.test(css) && !/@import\s+['"]/i.test(executiveCss) && !/@import\s+['"]/i.test(studioCss) && css.includes('.bm-v3000-play-publication') && executiveCss.includes('.bm-v33-sidebar') && studioCss.includes('.bm-v3400-studio'), 'Tema de produção e camada Executive consolidados');
check(layout.includes('bm-v3000-play-publication') && layout.includes('bm-v3300-executive') && layout.includes('v33-executive.css') && layout.includes('bm-v3400-studio') && layout.includes('v34-studio.css'), 'Escopo visual v33 ativo');
