...
check(version === '40.10.0', 'Versão v40.10 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v40.10' && manifest.short_name === 'BuildMaster v40.10', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v40-10-progress-1'), 'Cache PWA v40.10 renovado');
