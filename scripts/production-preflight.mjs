...
check(version === '32.00.0', 'Versão v32.00 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v32.00' && manifest.short_name === 'BuildMaster v32.00', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v32-00'), 'Cache PWA renovado');
