...
check(version === '37.00.0', 'Versão v37.00 configurada', version);
...
check(dataSafety.includes(`APP_DATA_VERSION = '${version}'`) && dataSafety.includes('CURRENT_DATA_SCHEMA = 3100'), 'Esquema de dados sincronizado');
check(manifest.name === 'BuildMaster Elite Tático v37.00' && manifest.short_name === 'BuildMaster v37.00', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v37-00-professional-intelligence-1'), 'Cache PWA renovado');
