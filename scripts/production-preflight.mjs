...
check(version === '31.77.0', 'Versão v31.77 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.77' && manifest.short_name === 'BuildMaster v31.77', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-77'), 'Cache PWA renovado');
