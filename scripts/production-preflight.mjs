...
check(version === '31.73.0', 'Versão v31.73 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.73' && manifest.short_name === 'BuildMaster v31.73', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-73'), 'Cache PWA renovado');
