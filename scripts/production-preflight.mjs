...
check(version === '38.37.0', 'Versão v38.37 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v38.37' && manifest.short_name === 'BuildMaster v38.37', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v38-37-automatic-card-gameplay-1'), 'Cache PWA v38.37 renovado');
