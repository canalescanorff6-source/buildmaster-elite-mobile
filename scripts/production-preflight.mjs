...
check(version === '40.00.0', 'Versão v40.00 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v40.00' && manifest.short_name === 'BuildMaster v40.00', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v40-00-card-reader-rebuild-1'), 'Cache PWA v40.00 renovado');
