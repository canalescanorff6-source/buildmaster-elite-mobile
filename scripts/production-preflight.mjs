...
check(version === '31.79.0', 'Versão v31.79 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.79' && manifest.short_name === 'BuildMaster v31.79', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-79'), 'Cache PWA renovado');
...
check(resultWorkspaceSource.includes('Top 5 por função v31.79'), 'Auditoria de habilidades visível no resultado');
