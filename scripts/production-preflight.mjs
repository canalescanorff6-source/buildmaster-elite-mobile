...
check(version === '31.80.0', 'Versão v31.80 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.80' && manifest.short_name === 'BuildMaster v31.80', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-80'), 'Cache PWA renovado');
