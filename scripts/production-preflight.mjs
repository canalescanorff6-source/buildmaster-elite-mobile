...
check(version === '31.75.0', 'Versão v31.75 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.75' && manifest.short_name === 'BuildMaster v31.75', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-75'), 'Cache PWA renovado');
