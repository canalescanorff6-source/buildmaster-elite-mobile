...
check(version === '31.74.0', 'Versão v31.74 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.74' && manifest.short_name === 'BuildMaster v31.74', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-74'), 'Cache PWA renovado');
