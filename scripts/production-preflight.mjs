...
check(version === '31.81.0', 'Versão v31.81 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.81' && manifest.short_name === 'BuildMaster v31.81', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-81'), 'Cache PWA renovado');
