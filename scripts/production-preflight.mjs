...
check(version === '31.82.0', 'Versão v31.82 configurada', version);
...
check(manifest.name === 'BuildMaster Elite Tático v31.82' && manifest.short_name === 'BuildMaster v31.82', 'Manifesto PWA sincronizado');
check(sw.includes('buildmaster-v31-82'), 'Cache PWA renovado');
