...
check(manifest.name === 'Marques Fichas v31.78' && manifest.short_name === 'Marques Fichas', 'Manifesto PWA sincronizado');
check(sw.includes('marques-fichas-v31-78'), 'Cache PWA renovado');
