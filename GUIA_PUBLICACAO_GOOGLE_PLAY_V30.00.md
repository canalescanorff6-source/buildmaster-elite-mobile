# Guia de publicação Google Play — BuildMaster v30.00

## 1. Preparar o backend

- Aplique todas as migrações Supabase, incluindo `202607250002_block28_play_publication.sql`.
- Publique as funções `account-deletion-request` e `play-integrity-verify`.
- Configure os Secrets das funções.
...
Cadastre as Variables e Secrets descritas no README. Execute o workflow **Gerar AAB v30.00 Google Play** primeiro com:
