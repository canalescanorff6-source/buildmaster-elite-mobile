...
import { POSITION_PT } from '../../src/lib/analyzerDomain';
...
import { applyLocalAiToResult } from '../../src/lib/localAiEngine';
import { cardFingerprint } from '../../src/lib/appEvolution';
import { emptyTraining, trainingPlanCost, trainingPlanTotalCost } from '../../src/lib/trainingPlanCore';
...
export function applyCanonicalCardV3890(result: AnalysisResult): AnalysisResult {
  ...
  const variant = {
    ...
    title: `Ficha Automática v40.40 — Receita Canônica v38.90 — ${result.parsed.playerName}`,
