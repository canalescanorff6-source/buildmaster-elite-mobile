...
import { POSITION_PT, type AnalysisResult } from '@/lib/analyzerDomain';
    ...
    <div className="advanced-motor-v3750 max-match-v3860">
      <article className="luxury-panel wide-card advanced-motor-hero">
        ...
        <div className="advanced-motor-winner">
          <div><Target size={22}/><span>Microfunção</span><strong>{analysis.microRole}</strong><small>posição preservada em {POSITION_PT[analysisUsagePositionR138(result)]}</small></div>
