...
for (const item of cases) {
  ...
  assert.equal(result.cleanSlate2027R119.guards.exactBudget,true,'v40-80-r143-clean-slate-equivalent-state-cache-regression: orçamento atual precisa continuar exato.');
