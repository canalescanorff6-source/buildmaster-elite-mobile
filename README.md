# BuildMaster Elite Tático v38.33 — Gerador Tático Profissional por Template

A v38.33 foi construída sobre a v38.32 e transforma o Estúdio de Formações em um gerador local de artes táticas detalhadas, sem IA paga. O template usa SVG determinístico, mantém exatamente 11 jogadores, organiza setas atrás dos marcadores e exporta PNG/PDF no padrão premium Marques Fichas.

Consulte:

- `GERADOR_TATICO_PROFISSIONAL_V38.33.md`;
- `TESTES_V38.33.md`;
- `INSTRUCOES_PUBLICACAO_V38.33.md`;
- `RELEASE_NOTES_V38.33.md`.
